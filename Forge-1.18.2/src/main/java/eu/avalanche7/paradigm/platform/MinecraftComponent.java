...
public class MinecraftComponent implements IComponent {
    ...
    public IComponent onHoverText(String text) {
        Component hover = new TextComponent(text != null ? text : "");
    ...
    public IComponent onHoverComponent(IComponent component) {
        ...
        Component hover = orig instanceof Component c ? c : new TextComponent(component != null ? component.getRawText() : "");
    ...
    public IComponent withItalic(boolean italic) {
        return new MinecraftComponent(component.copy().withStyle(style -> style.withItalic(italic)));
    }
}

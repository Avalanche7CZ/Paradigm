...
public final class MinecraftMenuPlatform implements IMenuPlatform {
    ...
    static ItemStack toStack(ItemSpec spec) {
        ...
        Item item = identifier != null ? Registries.ITEM.get(identifier) : Items.AIR;
        if (item == Items.AIR) {
            item = Items.BARRIER;
        }
        ...
        if (lore != null && !lore.isEmpty()) {
            ...
            for (IComponent line : lore) {
                ...
                lines.add(text != null ? text : Text.empty());
            }
        ...
        if (spec.hideTooltip()) {
            stack.set(DataComponentTypes.TOOLTIP_DISPLAY,
                    new net.minecraft.component.type.TooltipDisplayComponent(
                            true, new java.util.LinkedHashSet<net.minecraft.component.ComponentType<?>>()));
        }
        return stack;
    }

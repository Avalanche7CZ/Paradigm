...
public class FlyCommand implements ParadigmModule {
    ...
    public void registerCommands(Object dispatcher, Object registryAccess, Services services) {
        ICommandBuilder cmd = services.getPlatformAdapter().createCommandBuilder()
                ...
                .requires(src -> services.getCommandToggleStore().isEnabled("fly")
                        && src.getPlayer() != null
                        && services.getPermissionsHandler().hasPermission(src.getPlayer(), ParadigmPermissions.FLY))
    ...
    private boolean canTargetOther(IPlayer actor, IPlayer target) {
        ...
        return services.getPermissionsHandler().hasPermission(actor, ParadigmPermissions.FLY_OTHERS);
    }

...
public abstract class AbstractAdminCommand implements ParadigmModule {
    ...
    protected boolean canTargetOther(IPlayer actor, IPlayer target, PermissionDefinition permission) {
        return permission != null && canTargetOther(actor, target, permission.node(), permission.fallbackLevel());
    }

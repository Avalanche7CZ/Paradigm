...
public class Placeholders {
    ...
    public String replacePlaceholders(String text, EntityPlayerMP player) {
        if (text == null) return "";
        if (player == null) {
        ...
        replacedText = replacedText.replace("{player}", player.getName());
        replacedText = replacedText.replace("{player_name}", player.getName());
        replacedText = replacedText.replace("{player_uuid}", player.getUniqueID().toString());

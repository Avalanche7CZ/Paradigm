...
public class Paradigm {
    ...
    public Paradigm() {
        ...
        registerModules();
        modules.forEach(module -> module.onLoad(null, services, NeoForge.EVENT_BUS));
        modules.forEach(module -> module.registerEventListeners(NeoForge.EVENT_BUS, services));
        ModList.get().getModContainerById(MOD_ID).ifPresent(modContainer -> {
            ...
            LOGGER.info("==================================================");
            LOGGER.info("{} - Version {}", displayName, version + " - NEOFORGE");

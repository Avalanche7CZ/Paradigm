...
public class Announcements {
    ...
    private static void broadcastActionbarMessages() {
        ...
        MutableComponent message = ColorUtils.parseMessageWithColor(messageText);
        server.getPlayerList().getPlayers().forEach(player -> player.connection.send(new ClientboundSetActionBarTextPacket(message)));
    ...
    private static void broadcastBossbarMessages() {
        ...
        server.getPlayerList().getPlayers().forEach(player -> player.connection.send(addPacket));
        ...
        TaskScheduler.schedule(() -> {
            ...
            server.getPlayerList().getPlayers().forEach(player -> player.connection.send(removePacket));
